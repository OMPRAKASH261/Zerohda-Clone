    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Online Account Openeing
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            NRI Account Openeing
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Charges at Zerodha
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Transfer adn conversation of shares
          </a>
          <br />
        </div>
        <div className="col-4 p-5 mt-2 mb-2">
        ...
        <div className="col-4 p-5  mb-2">
          <h4 className="">
            <i class="fa fa-circle-o-notch" aria-hidden="true" style={{width: "30px"}}></i>Console
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Reports
          </a>
        ...
        <div className="col-4 p-5 mb-2">
          <h4 className="">
            <i class="fa fa-circle-o" aria-hidden="true" style={{width: "30px"}}></i>Coin
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Mutual funds
          </a>
